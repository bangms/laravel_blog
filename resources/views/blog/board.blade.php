  ...
  <div class='window'>
    ...
    <div class='content'>
      <div class='input-fields'>
        <input type='text' placeholder='Subject' class='input-line full-width'></input>
        <textarea placeholder='Content' class='input-line full-width' id="content"></textarea>
      </div>
      <div><button class='ghost-round full-width'>Create </button></div>
    </div>
  </div>
</div>
</body>
