...
<div class="container">
  <div class="window">
    ...
    <div class="content">
      <form action="/blog" method="post" class="input-fields">
        @csrf
        <input type="text" name="subject" placeholder="Subject" class="input-line full-width" />
        <textarea placeholder="Content" name="content" class="input-line full-width" id="content"></textarea>
        <input value="Create" class="ghost-round full-width" type="submit" />
      </form>
    </div>
  </div>
</div>
